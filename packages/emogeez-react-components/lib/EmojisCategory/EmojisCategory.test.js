...
describe('EmojisCategory', () => {
  ...
  it('should render properly', () => {
    ...
    expect(emojis.children.length)
      .to
      .equal(384);
    const grinningFace = emojis.children[0].children[0];
    expect(grinningFace.className)
      .to
      .equal('emojiContainer emojisCategoryEmoji emojisCategoryEmojiHasModifiers emojis-grinning-face');
    const man = emojis.children[105].children[0];
    expect(man.className)
      .to
      .equal('emojiContainer emojisCategoryEmoji emojisCategoryEmojiHasModifiers emojis-cat-face-with-wry-smile');
  });
  ...
  it('should open the modifiers popup', () => {
    ...
    const man = emojis.children[111].children[0];
    onClickSpy.reset();
    expect(onClickSpy.callCount)
      .to
      .equal(0);
