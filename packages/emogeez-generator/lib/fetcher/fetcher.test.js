...
const indexJSON = map(require(`${process.cwd()}/tests/jsons/categories.json`), category => category); // eslint-disable-line
const categoryHTML = fs.readFileSync(`${process.cwd()}/tests/html/people.html`, 'utf8');
const categoryEmojis = require(`${process.cwd()}/tests/jsons/emojisForCategory.json`).people.emojis; // eslint-disable-line
